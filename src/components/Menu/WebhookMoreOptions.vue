  ...
  >
    ...
    >
      ...
      <q-item
        ...
        :key="`webhook-profile-action-${index}`"
...
export default defineComponent({
  name: 'WebhookMoreOptions',

  emits: ['editWebhook', 'deleteWebhook', 'updateWebhookStatus'],
