<template>
  <q-card flat class="app-modal-card delete-reply-category-card">
    <!-- header -->
    ...
    <div class="app-modal-content">
      <p class="delete-warning-text">
        Deleting the reply category will
      ...
      <q-checkbox
        ...
        color="primary"
        label="I understand the consequences of deleting the reply category"
      />
    </div>
