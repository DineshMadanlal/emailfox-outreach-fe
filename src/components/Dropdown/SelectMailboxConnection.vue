...
// Constants
import { MAILBOX_STATUS_LABELS } from 'boot/mailbox-constants';

export default defineComponent({
  name: 'SelectMailboxConnection',
  ...
  setup(props, { emit }) {
    ...
    const dropdownOptions = computed(() => Object.values(MAILBOX_STATUS_LABELS));
