<template>
  <div class="import-step-summary hide-scrollbar">
    <div
      v-for="(data, index) in contactsImportSteps"
      :key="`contacts-import-step-${index}`"
      class="contacts-import-stepper"
...
export default defineComponent({
  ...
  setup() {
    // computed
    const contactsImportSteps = computed(() => Object.values(CONTACTS_IMPORT_STEPS));
